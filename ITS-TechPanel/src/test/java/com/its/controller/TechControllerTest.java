...
@WebMvcTest(TechPanelController.class)
class TechControllerTest {
	...
	@Autowired
	TechPanelController techPanelController;
	...
	public void testviewInterviewCandidates() throws Exception {
		...
		MvcResult mvcResult=this.mockMvc.perform(get("http://localhost:7001/its-tech/candidate")
				.headers(httpHeaders)
				)
	...
	//Service 3
		...
		public void testGetCandidateById() throws Exception{
			...
			MvcResult mvcResult=this.mockMvc.perform(get("http://localhost:7001/its-tech/candidate/"+1)
					.headers(httpHeaders)
					)
					.andExpect(status().isOk())
		...
		public void testResignTechPanelMember() throws Exception{
			...
			MvcResult mvcResult=this.mockMvc.perform(delete("http://localhost:7001/its-tech/tech/"+1)
					.headers(httpHeaders)
					)
					.andExpect(status().isOk())
					.andReturn();
		...
		public void testViewInterviewSchedules() throws Exception {
			...
			MvcResult mvcResult=this.mockMvc.perform(get("http://localhost:7001/its-tech/interview")
